...
const InnerTabPanel = ({ type, active, contractName, contractCode }) => {
  ...
  return (
    <div className={tabPanelClasses}>
      ...
      {type === 'Control Flow Graph' && <ControlFlowGraphComp contractName={contractName} contractCode={contractCode} />}
    </div>
  );
}
