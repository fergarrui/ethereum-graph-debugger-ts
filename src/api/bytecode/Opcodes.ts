...
export class Opcodes {
  ...
  constructor() {
    ...
    this.opcodes[0x69] = { name: 'PUSH10', opcode: 0x69, parameters: 1} as Opcode
    this.opcodes[0x6a] = { name: 'PUSH11', opcode: 0x6a, parameters: 1} as Opcode
    this.opcodes[0x6b] = { name: 'PUSH12', opcode: 0x6b, parameters: 1} as Opcode
    this.opcodes[0x6c] = { name: 'PUSH13', opcode: 0x6c, parameters: 1} as Opcode
    this.opcodes[0x6d] = { name: 'PUSH14', opcode: 0x6d, parameters: 1} as Opcode
    this.opcodes[0x6e] = { name: 'PUSH15', opcode: 0x6e, parameters: 1} as Opcode
    this.opcodes[0x6f] = { name: 'PUSH16', opcode: 0x6f, parameters: 1} as Opcode
    this.opcodes[0x70] = { name: 'PUSH17', opcode: 0x70, parameters: 1} as Opcode
    this.opcodes[0x71] = { name: 'PUSH18', opcode: 0x71, parameters: 1} as Opcode
    this.opcodes[0x72] = { name: 'PUSH19', opcode: 0x72, parameters: 1} as Opcode
    this.opcodes[0x73] = { name: 'PUSH20', opcode: 0x73, parameters: 2} as Opcode
    this.opcodes[0x74] = { name: 'PUSH21', opcode: 0x74, parameters: 2} as Opcode
    this.opcodes[0x75] = { name: 'PUSH22', opcode: 0x75, parameters: 2} as Opcode
    this.opcodes[0x76] = { name: 'PUSH23', opcode: 0x76, parameters: 2} as Opcode
    this.opcodes[0x77] = { name: 'PUSH24', opcode: 0x77, parameters: 2} as Opcode
    this.opcodes[0x78] = { name: 'PUSH25', opcode: 0x78, parameters: 2} as Opcode
    this.opcodes[0x79] = { name: 'PUSH26', opcode: 0x79, parameters: 2} as Opcode
    this.opcodes[0x7a] = { name: 'PUSH27', opcode: 0x7a, parameters: 2} as Opcode
    this.opcodes[0x7b] = { name: 'PUSH28', opcode: 0x7b, parameters: 2} as Opcode
    this.opcodes[0x7c] = { name: 'PUSH29', opcode: 0x7c, parameters: 2} as Opcode
    this.opcodes[0x7d] = { name: 'PUSH30', opcode: 0x7d, parameters: 3} as Opcode
    this.opcodes[0x7e] = { name: 'PUSH31', opcode: 0x7e, parameters: 3} as Opcode
    this.opcodes[0x7f] = { name: 'PUSH32', opcode: 0x7f, parameters: 3} as Opcode
