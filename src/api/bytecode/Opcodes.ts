...
export class Opcodes {
  ...
  static populate() {
    ...
    this.opcodes[0x43] = { name: 'NUMBER', opcode: 0x43, parameters: 0 } as Opcode // TODO
    this.opcodes[0x44] = { name: 'DIFFICULTY', opcode: 0x44, parameters: 0 } as Opcode // TODO
    this.opcodes[0x45] = { name: 'GASLIMIT', opcode: 0x45, parameters: 0 } as Opcode // TODO
    ...
    this.opcodes[0x5a] = { name: 'GAS', opcode: 0x5a, parameters: 0 } as Opcode // TODO
